// pages/api/deleteAccountByAdmin.js

import supabase from 'lib/supabaseClient';
import {getUserFromRequest} from "lib/getUserFromRequest";

export default async function DeleteAccountByAdmin(req, res) {
    ...
    try {
        ...
        if (!userToDelete) {
            return res.status(400).json({error: 'No user provided for deletion'});
        }
